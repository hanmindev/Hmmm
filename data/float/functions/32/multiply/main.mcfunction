...
execute if score 8 temp matches 1 run function float:32/multiply/exception/nan
execute if score 8 temp matches 0 run function float:32/multiply/branch0
